...
public class HintedHandoffNodetoolTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testDisableHandoff()
    {
        ...
        RestartFramework.at("after_disable_handoff").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_enable_handoff").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
        cluster.get(node).nodetoolResult("statushandoff").asserts().success().stdoutContains("Hinted handoff is running");
    }
    ...
    public void testDisableForDC()
    {
        ...
        RestartFramework.at("after_disable_hints_for_dc").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_enable_hints_for_dc").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testPauseHandoff()
    {
        ...
        RestartFramework.at("after_pause_handoff").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_resume_handoff").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testThrottle()
    {
        ...
        RestartFramework.at("after_set_throttle").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMaxHintWindow()
    {
        ...
        RestartFramework.at("after_set_max_hint_window").on(cluster).restart("node").withIndex(node - 1).withMode(RestartMode.GRACEFUL).execute();
