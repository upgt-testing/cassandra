...
public class AlterTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void getAndSetCompressionParametersTest() throws Throwable
    {
                                                                  ...
                                                                  .start()))
        {
            ...
            RestartFramework.at("after_set_compression")
                .on((Cluster) cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_add_column")
                .on((Cluster) cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void alteringKeyspaceOnInsufficientNumberOfReplicasFiltersOutGossppingOnlyMembersTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_keyspace_operations")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void unknownMemtableConfigurationTest() throws Throwable
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_node2_add")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_fail")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_success")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node3_add")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_insert_node3")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
