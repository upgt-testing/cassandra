...
public class HintsPersistentWindowTest_RestartInjected extends AbstractHintWindowTest
{
    @Test
    public void testPersistentHintWindow() throws Exception
    {
                                           ...
                                           .start(), 2))
        {
            ...
            RestartFramework.at("after_pause_hints_delivery")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_hints_size_assertion")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
