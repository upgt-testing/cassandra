...
public class JMXFeatureTest_RestartInjected extends TestBaseImpl
{
    ...
    private void testJmxFeatures(INodeProvisionStrategy.Strategy provisionStrategy) throws Exception
    {
        ...
        for (int i = 0; i < iterations; i++)
        {
                                          ...
                                          .withConfig(c -> c.with(Feature.values())).start())
            {
                ...
                RestartFramework.at("after_instance_tests")
                    .on(cluster)
                    .restart("node")
                    .withIndex(1)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_all_getters_test")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
    ...
    public void testShutDownAndRestartInstances() throws Exception
    {
        ...
        try (Cluster cluster = Cluster.build(2).withConfig(c -> c.with(Feature.values())).start())
        {
            ...
            RestartFramework.at("after_first_instance_test")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_instance_stop")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_ring_status_down")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_nodetool_status_down")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_instance_restart")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_ring_status_up")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_nodetool_status_up")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
