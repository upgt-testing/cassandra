...
public class LegacyCASTest_RestartInjected extends CASCommonTestCases
{
    ...
    public void simpleUpdate() throws Throwable
    {
        ...
        RestartFramework.at("after_cas_insert")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_serial_select")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_failed_cas_update")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_successful_cas_update")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void incompletePrepare() throws Throwable
    {
        ...
        RestartFramework.at("after_incomplete_prepare")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_cas_update")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void incompletePropose() throws Throwable
    {
        ...
        RestartFramework.at("after_incomplete_propose")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_drop_filter_setup")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void incompleteCommit() throws Throwable
    {
        ...
        RestartFramework.at("after_incomplete_commit")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRepairIncompletePropose() throws Throwable
    {
        ...
        for (int repairWithout = 1 ; repairWithout <= 3 ; ++repairWithout)
        {
            ...
            {
                RestartFramework.at("after_drop_filter_setup_iteration_" + repairWithout)
                    .on(getCluster())
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_incomplete_propose_iteration_" + repairWithout)
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_paxos_repair_iteration_" + repairWithout)
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            try (AutoCloseable drop = drop(getCluster(), repairWith, to(repairWithout), to(), to()))
            {
                ...
                if (repairWithout == 1) assertRows(rows);
                else assertRows(rows, row(repairWithout, 1, 1));
            }
        }
    }
    ...
    public void testRepairIncompleteCommit() throws Throwable
    {
        ...
        for (int repairWithout = 1 ; repairWithout <= 3 ; ++repairWithout)
        {
            ...
            RestartFramework.at("after_incomplete_commit_iteration_" + repairWithout)
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testAbortedRangeMovement() throws Throwable
    {
        try (Cluster cluster = Cluster.create(4, config()))
        {
            ...
            RestartFramework.at("after_gossip_ring_manipulation")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_cas_operation")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_abort_node3_start_node4")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_filter_setup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
