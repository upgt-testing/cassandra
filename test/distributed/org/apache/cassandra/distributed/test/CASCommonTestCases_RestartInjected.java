...
public abstract class CASCommonTestCases_RestartInjected extends CASTestBase
{
    ...
    public void incompletePrepare() throws Throwable
    {
        ...
        RestartFramework.at("after_filter_off")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void incompletePropose() throws Throwable
    {
        ...
        RestartFramework.at("after_prepare_filter_setup")
            .on(getCluster())
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void incompleteCommit() throws Throwable
    {
        ...
        try (AutoCloseable drop = drop(getCluster(), 1, to(2), to(2), to()))
        {
            ...
            RestartFramework.at("after_cas_update_with_filter")
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRepairIncompletePropose() throws Throwable
    {
        ...
        for (int repairWithout = 1 ; repairWithout <= 3 ; ++repairWithout)
        {
            ...
            RestartFramework.at("after_incomplete_propose_timeout")
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_paxos_repair")
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_repair_verification")
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRepairIncompleteCommit() throws Throwable
    {
        ...
        for (int repairWithout = 1 ; repairWithout <= 3 ; ++repairWithout)
        {
            ...
            RestartFramework.at("after_incomplete_commit_timeout")
                .on(getCluster())
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
