...
public class NativeMixedVersionTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void v4ConnectionCleansUpThreadLocalState() throws IOException
    {
             ...
             )
        {
            ...
            RestartFramework.at("after_v5_protocol_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_v3_protocol_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
