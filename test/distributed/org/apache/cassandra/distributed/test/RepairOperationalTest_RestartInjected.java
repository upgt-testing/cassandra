...
public class RepairOperationalTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void compactionBehindTest() throws IOException
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_threshold_set")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_repair_rejection")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_reduce_compactions")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void repairUnreplicatedKStest() throws IOException
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_repair_failure")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
