 ...
 */
public class HintsServiceMetricsTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testHintsServiceMetrics() throws Exception
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_first_half_writes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_half_writes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_hints_applied")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_coordinator_metrics_verified")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_delay_metrics_verified")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
