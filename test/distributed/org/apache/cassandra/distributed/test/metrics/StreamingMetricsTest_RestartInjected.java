...
public class StreamingMetricsTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testMetricsWithStreamingFromTwoNodes(boolean useRepair) throws Exception
    {
                                          ...
                                          .start(), 2))
        {
            ...
            RestartFramework.at("before_repair_or_rebuild")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_repair_or_rebuild")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testMetricsWithStreamingToTwoNodes(boolean useRepair) throws Exception
    {
                                          ...
                                          .start(), 2))
        {
            ...
            RestartFramework.at("after_table_create_to_two")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_autocompaction_disabled")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_batch_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_batch_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("before_repair_or_rebuild_to_two")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_repair_or_rebuild_to_two")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
