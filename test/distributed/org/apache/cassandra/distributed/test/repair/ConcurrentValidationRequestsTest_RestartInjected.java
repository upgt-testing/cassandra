 ...
 * requests.
 */
public class ConcurrentValidationRequestsTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testConcurrentValidations() throws Throwable
    {
        try (Cluster cluster = init(builder().withNodes(NODES)
                                             .withInstanceInitializer(ConcurrentValidationRequestsTest_RestartInjected.BBHelper::install)
    ...
    public static class BBHelper
    {
        ...
        public static void install(ClassLoader cl, int node)
        {
            ...
            new ByteBuddy().rebase(ValidationTask.class)
                           .method(named("run"))
                           .intercept(MethodDelegation.to(ConcurrentValidationRequestsTest_RestartInjected.BBHelper.class))
