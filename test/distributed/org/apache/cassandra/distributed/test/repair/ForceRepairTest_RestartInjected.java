...
public class ForceRepairTest_RestartInjected extends TestBaseImpl
{
    /**
    ...
    private void force(boolean includeDifference) throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_failure_detector_wait")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_repair_tests")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
