...
public class StreamsDiskSpaceTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testAbortStreams() throws Exception
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("before_repair_failure")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("before_successful_repair")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
