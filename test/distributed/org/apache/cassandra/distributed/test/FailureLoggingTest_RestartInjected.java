...
public class FailureLoggingTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testRequestBootstrapFail() throws Throwable
    {
        ...
        RestartFramework.at("after_bootstrap_state_set")
            .on(cluster)
            .restart("node")
            .withIndex(0)
        ...
        RestartFramework.at("after_bootstrap_fail_logged")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testRangeRequestFail() throws Throwable
    {
        ...
        RestartFramework.at("after_range_fail_logged")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testReadRequestFail() throws Throwable
    {
        ...
        RestartFramework.at("after_read_fail_logged")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
