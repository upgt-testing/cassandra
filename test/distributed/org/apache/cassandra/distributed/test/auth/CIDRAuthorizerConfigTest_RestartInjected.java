...
public class CIDRAuthorizerConfigTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testParameterizedClass() throws IOException
    {
        try (Cluster cluster = init(builder().withNodes(1)
                                             ...
                                             .start()))
        {
            RestartFramework.at("after_cidr_config_start")
                .on(cluster)
                .restart("node")
                .withIndex(0)
    ...
    public void testParameterizedClass_no_params() throws IOException
    {
        try (Cluster cluster = init(builder().withNodes(1)
                                             ...
                                             .start()))
        {
            RestartFramework.at("after_cidr_no_params_start")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
