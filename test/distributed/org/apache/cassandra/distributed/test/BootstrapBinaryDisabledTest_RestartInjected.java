 ...
 */
public class BootstrapBinaryDisabledTest_RestartInjected extends TestBaseImpl
{
    ...
    public void test() throws IOException, TimeoutException
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_first_bootstrap")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_bootstrap")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
