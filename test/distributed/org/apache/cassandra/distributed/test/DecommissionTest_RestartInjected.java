...
public class DecommissionTest_RestartInjected extends TestBaseImpl
{
    @Test
    ...
    public void testDecommissionAfterNodeRestart() throws Throwable
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_failed_decommission")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_manual_restart")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_successful_decommission")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
