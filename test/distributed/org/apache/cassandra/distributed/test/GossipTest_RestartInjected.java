...
public class GossipTest_RestartInjected extends TestBaseImpl
{
    ...
    public void nodeDownDuringMove() throws Throwable
    {
                                      ...
                                      .createWithoutStarting())
        {
            ...
            RestartFramework.at("after_normal_state")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_moving_state")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_late_node_startup")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testBusyGossipBusyShouldNotCreateParitialGossipInfoOnOtherNodes() throws Exception
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_new_node_gossip_propagate")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_removed")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_gossip_recovery")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testPreventEnablingGossipDuringMove() throws Exception
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_gossip_operations")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void gossipShutdownUpdatesTokenMetadata() throws Exception
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_populate")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_move_initiation")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void restartGossipOnGossippingOnlyMember() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_gossip_running_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_gossip_restart")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
