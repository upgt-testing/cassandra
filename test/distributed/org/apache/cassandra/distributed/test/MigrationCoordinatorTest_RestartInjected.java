...
public class MigrationCoordinatorTest_RestartInjected extends TestBaseImpl
{
    ...
    public void explicitVersionIgnore() throws Throwable
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_initial_version")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_version_change")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
