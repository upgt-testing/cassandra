...
public class IncRepairAdminTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testRepairAdminSummarizePending() throws IOException
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_repair_admin_summarize")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    private void repairAdminCancelHelper(boolean coordinator, boolean force) throws IOException
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_check_no_sessions")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_make_fake_session")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_await_repairing_state")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_cancel_command")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            if (shouldFail)
            {
                ...
                RestartFramework.at("after_verify_still_repairing")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
            ...
            else
            {
                ...
                RestartFramework.at("after_verify_failed_state")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
