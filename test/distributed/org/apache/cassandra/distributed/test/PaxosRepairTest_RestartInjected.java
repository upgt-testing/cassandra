...
public class PaxosRepairTest_RestartInjected extends TestBaseImpl
{
    ...
    public void paxosRepairTest() throws Throwable
    {
        ...
        try (Cluster cluster = init(Cluster.build(3).withConfig(WITH_NETWORK).withoutVNodes().start()))
        {
            ...
            RestartFramework.at("after_first_cas")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_final_cas")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void topologyChangePaxosTest() throws Throwable
    {
        ...
        try (Cluster cluster = Cluster.build(4).withConfig(WITH_NETWORK).withoutVNodes().createWithoutStarting())
        {
            ...
            RestartFramework.at("after_node4_startup")
                .on(cluster)
                .restart("node")
                .withIndex(3)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void paxosCleanupWithReproposal() throws Throwable
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_paxos_flush")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
