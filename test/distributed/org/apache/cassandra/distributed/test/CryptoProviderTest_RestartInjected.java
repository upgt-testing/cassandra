...
public class CryptoProviderTest_RestartInjected extends TestBaseImpl
{
    @Before
    ...
    public void testDefaultCryptoProvider() throws Throwable
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_provider_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testUsingJREProvider() throws Throwable
    {
        try (Cluster cluster = init(Cluster.build(1)
                                           ...
                                           .start()))
        {
            RestartFramework.at("after_cluster_startup_jre")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_jre_provider_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testUsingNoProviderUsesJREProvider() throws Throwable
    {
        ...
        {
            RestartFramework.at("after_cluster_startup_default")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_provider_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testFailedDefaultProviderInstallationShouldResumeStartup() throws Throwable
    {
                                        ...
                                        .createWithoutStarting())
        {
            ...
            RestartFramework.at("after_failed_provider_startup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_failed_provider_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
