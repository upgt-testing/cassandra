...
public class PaxosRepair2Test_RestartInjected extends TestBaseImpl
{
    ...
    public void paxosRepairPreventsStaleReproposal() throws Throwable
    {
        ...
        )
        {
            ...
            RestartFramework.at("after_node_restart")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_stale_proposal_saved")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node3_shutdown")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_cas_query")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void paxosRepairHistoryIsntUpdatedInForcedRepair() throws Throwable
    {
        ...
        )
        {
            ...
            RestartFramework.at("after_node3_stopped")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_forced_repair")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void paxosAutoRepair() throws Throwable
    {
             ...
             )
        {
            ...
            RestartFramework.at("after_paxos_commit_drop")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_cas_timeout")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_system_flush")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_enable_auto_repairs")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void legacyPurgeRepairLoop() throws Exception
    {
        try
        {
            ...
            )
            {
                ...
                RestartFramework.at("after_first_cas_timeout")
                    .on(cluster)
                    .restart("node")
                    .withIndex(2)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_second_cas")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_auto_repair")
                    .on(cluster)
                    .restart("node")
                    .withIndex(2)
                    .withMode(RestartMode.GRACEFUL)
