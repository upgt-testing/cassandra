...
public class RepairDigestTrackingTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testInconsistenciesFound() throws Throwable
    {
        try (Cluster cluster = init(builder().withNodes(2).start()))
        {
            ...
            RestartFramework.at("after_enable_tracking")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_mark_repaired")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_create_inconsistency")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_range_read")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testPurgeableTombstonesAreIgnored() throws Throwable
    {
        try (Cluster cluster = init(builder().withNodes(2).start()))
        {
            ...
            RestartFramework.at("after_tombstone_flush")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mark_all_repaired")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_overwrite")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testSnapshottingOnInconsistency() throws Throwable
    {
        try (Cluster cluster = init(Cluster.create(2)))
        {
            ...
            RestartFramework.at("after_create_mismatch")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_partition_read")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_enable_snapshot")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRepairedReadCountNormalizationWithInitialUnderread() throws Throwable
    {
        ...
        try (Cluster cluster = init(Cluster.create(2)))
        {
            ...
            RestartFramework.at("after_unrepaired_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node2_insert")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_recreate_mismatch")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRepairedReadCountNormalizationWithInitialOverread() throws Throwable
    {
        ...
        try (Cluster cluster = init(Cluster.create(2)))
        {
            ...
            RestartFramework.at("after_unrepaired_flush")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_deletions")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testLocalDataAndRemoteRequestConcurrency() throws Exception
    {
                                           ...
                                           .start()))
        {
            ...
            RestartFramework.at("after_schema_setup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_select")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
