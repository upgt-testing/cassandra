...
public class HintDataReappearingTest_RestartInjected extends AbstractHintWindowTest
{
    ...
    public void doHintReappearData(final boolean preventReappearance, final boolean dropTwoWrites) throws Exception
    {
                ...
                .start(), 3))
        {
            ...
            RestartFramework.at("after_pause_hints")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_insert_and_filter_reset")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_hint_transfer")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
