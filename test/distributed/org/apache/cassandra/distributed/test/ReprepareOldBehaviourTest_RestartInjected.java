...
public class ReprepareOldBehaviourTest_RestartInjected extends ReprepareTestBase
{
    @Test
    ...
    public void testReprepareUsingOldBehavior() throws Throwable
    {
                                                            ...
                                                            .start()))
        {
                 ...
                 Session session = cluster.connect())
            {
                ...
                RestartFramework.at("after_prepare")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_first_execute")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_switch_node")
                    .on(c)
                    .restart("node")
                    .withIndex(1)
                    .withMode(RestartMode.GRACEFUL)
    ...
    public void testReprepareMixedVersionWithoutReset() throws Throwable
    {
                                                            ...
                                                            .start()))
        {
            ...
            RestartFramework.at("after_table_create_mixed")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
                ...
                for (boolean withUse : new boolean[]{ true, false })
                {
                    for (boolean clearBetweenExecutions : new boolean[]{ true, false })
                    {
                             ...
                             Session session = cluster.connect())
                        {
                            ...
                            RestartFramework.at("after_prepare_mixed")
                                .on(c)
                                .restart("node")
                                .withIndex(0)
                                .withMode(RestartMode.GRACEFUL)
                            ...
                            RestartFramework.at("after_first_execute_mixed")
                                .on(c)
                                .restart("node")
                                .withIndex(0)
                                .withMode(RestartMode.GRACEFUL)
                            ...
                            RestartFramework.at("after_second_execute_mixed")
                                .on(c)
                                .restart("node")
                                .withIndex(1)
                                .withMode(RestartMode.GRACEFUL)
                            ...
                            RestartFramework.at("after_third_execute_mixed")
                                .on(c)
                                .restart("node")
                                .withIndex(0)
                                .withMode(RestartMode.GRACEFUL)
