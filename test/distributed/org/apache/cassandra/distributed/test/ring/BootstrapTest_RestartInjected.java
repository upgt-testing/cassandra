...
public class BootstrapTest_RestartInjected extends TestBaseImpl
{
    ...
    public void bootstrapUnspecifiedFailsOnResumeTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_new_node_startup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_insert_available_ranges")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void bootstrapJMXStatus() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_verify_in_progress")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_resume_bootstrap")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
