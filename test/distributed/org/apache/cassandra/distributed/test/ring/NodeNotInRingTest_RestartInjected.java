...
public class NodeNotInRingTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void nodeNotInRingTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_gossip_filter")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_removal")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_ring_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
