...
public class CASContentionTest_RestartInjected extends CASTestBase
{
    ...
    public void testDynamicContentionTracing() throws Throwable
    {
        try
        {
            ...
            RestartFramework.at("after_contention_strategy_setup")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_insert")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_insert_complete")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tracing_complete")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_trace_query")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
