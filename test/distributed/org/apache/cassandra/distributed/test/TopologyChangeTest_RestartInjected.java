...
import org.apache.cassandra.distributed.test.TopologyChangeTest_RestartInjected.EventStateListener.Event;
...
import static org.apache.cassandra.distributed.test.TopologyChangeTest_RestartInjected.EventStateListener.EventType.Down;
import static org.apache.cassandra.distributed.test.TopologyChangeTest_RestartInjected.EventStateListener.EventType.Remove;
import static org.apache.cassandra.distributed.test.TopologyChangeTest_RestartInjected.EventStateListener.EventType.Up;
import static org.assertj.core.api.Assertions.assertThat;
import static org.awaitility.Awaitility.await;

@RunWith(Parameterized.class)
public class TopologyChangeTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testDecommission() throws Throwable
    {
             ...
             Session session = cluster.connect())
        {
            ...
            RestartFramework.at("after_metadata_update")
                .on(control)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testRestartNode() throws Throwable
    {
             ...
             Session session = cluster.connect())
        {
            ...
            RestartFramework.at("after_node_shutdown")
                .on(control)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_down_state")
                .on(control)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_startup")
                .on(control)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_up_state")
                .on(control)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
