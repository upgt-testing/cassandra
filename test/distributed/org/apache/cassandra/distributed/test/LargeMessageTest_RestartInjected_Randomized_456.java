...
public class LargeMessageTest_RestartInjected_Randomized_456 extends TestBaseImpl {
    ...
    public void testLargeMessage() throws Throwable {
        try (Cluster cluster = init(builder().withNodes(2).start())) {
            ...
            RestartFramework.at("after_large_insert").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
