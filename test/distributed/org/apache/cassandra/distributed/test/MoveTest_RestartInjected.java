...
public class MoveTest_RestartInjected extends TestBaseImpl
{
    ...
    private void move(boolean forwards) throws Throwable
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_cas_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("before_move")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_move")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
