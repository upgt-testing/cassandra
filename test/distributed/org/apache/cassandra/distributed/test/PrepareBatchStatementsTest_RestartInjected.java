...
public class PrepareBatchStatementsTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testPreparedBatch() throws Exception
    {
                                                            ...
                                                            .start()))
        {
                 ...
                 Session s = cluster.connect())
            {
                ...
                RestartFramework.at("after_first_batch_exec")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                prepared = s.prepare(batch1);
                s.execute(prepared.bind(1, 1, 1, 1, 1, 1));
                RestartFramework.at("after_second_batch_exec")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
