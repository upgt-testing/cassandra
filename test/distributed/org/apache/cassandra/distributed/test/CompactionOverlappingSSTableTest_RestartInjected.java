...
public class CompactionOverlappingSSTableTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void partialCompactionOverlappingTest() throws IOException, TimeoutException
    {
                                             ...
                                             .start()))
        {
            ...
            RestartFramework.at("after_deletes_and_flushes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("before_compaction")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
