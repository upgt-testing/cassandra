...
public class CASTest_RestartInjected extends CASCommonTestCases
{
    /**
    ...
    public void fastReadsAndFailedWrites() throws IOException
    {
        ...
        try
        {
            ...
            RestartFramework.at("after_serial_reads")
                .on(THREE_NODES)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testSuccessfulWriteBeforeRangeMovement() throws Throwable
    {
        ...
        RestartFramework.at("after_ring_change")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(2)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testConflictingWritesWithStaleRingInformation() throws Throwable
    {
        ...
        RestartFramework.at("after_first_cas_insert")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_second_cas_insert")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSucccessfulWriteDuringRangeMovementFollowedByRead() throws Throwable
    {
        ...
        RestartFramework.at("after_bootstrap_setup")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_topology_change")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(2)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testIncompleteWriteFollowedBySuccessfulWriteWithStaleRingDuringRangeMovementFollowedByRead() throws Throwable
    {
        ...
        RestartFramework.at("after_incomplete_cas")
            .on(FOUR_NODES)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
