...
public class AllowAutoSnapshotTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testAllowAutoSnapshotOnAutoSnapshotEnabled() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_table2_drop")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testDisableAndEnableAllowAutoSnapshot() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_disable_snapshot")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_drop")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testTruncateAllowAutoSnapshot() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_insert2")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_truncate2")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testMaterializedViewAllowAutoSnapshot() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_mv_create")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mv_drop")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mv2_create")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mv2_drop")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
