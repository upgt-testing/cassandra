...
public class CASAddTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testAdditionNotExists() throws Throwable
    {
        try (Cluster cluster = init(Cluster.create(3)))
        {
            ...
            RestartFramework.at("after_null_insert")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_null_update")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_batch_errors")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_real_insert")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testConcat() throws Throwable
    {
        try (Cluster cluster = init(Cluster.create(3)))
        {
            ...
            RestartFramework.at("after_failed_cas_concat")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_successful_cas_concat")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
