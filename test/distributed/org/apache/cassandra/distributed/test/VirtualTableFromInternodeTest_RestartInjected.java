...
public class VirtualTableFromInternodeTest_RestartInjected extends TestBaseImpl
{
    ...
    public void normal()
    {
        ...
        RestartFramework.at("after_first_query")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
        ...
        RestartFramework.at("after_second_query")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void readCommandAccessVirtualTable()
    {
        ...
        RestartFramework.at("after_virtual_table_read")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void readCommandAccessVirtualTableSinglePartition()
    {
        ...
        RestartFramework.at("after_single_partition_read")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void readCommandAccessVirtualTableMultiplePartition()
    {
        ...
        RestartFramework.at("after_multiple_partition_read")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
