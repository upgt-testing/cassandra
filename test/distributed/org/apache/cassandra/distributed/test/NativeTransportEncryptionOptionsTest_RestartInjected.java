...
public class NativeTransportEncryptionOptionsTest_RestartInjected extends AbstractEncryptionOptionsImpl
{
    @Rule
    ...
    public void optionalTlsConnectionDisabledWithoutKeystoreTest() throws Throwable
    {
        try (Cluster cluster = builder().withNodes(1).withConfig(c -> c.with(Feature.NATIVE_PROTOCOL)).createWithoutStarting())
        {
            ...
            RestartFramework.at("after_tls_connection_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void optionalTlsConnectionAllowedWithKeystoreTest() throws Throwable
    {
        ...
        }).createWithoutStarting())
        {
            ...
            RestartFramework.at("after_cluster_startup_with_keystore")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tls_negotiation")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void optionalTlsConnectionAllowedToRegularPortTest() throws Throwable
    {
        ...
        }).createWithoutStarting())
        {
            ...
            RestartFramework.at("after_cluster_startup_with_ssl_port")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_encrypted_port_connection")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            Assert.assertEquals("TLS native connection should not be possible on the regular port if an SSL port is specified",
                                ConnectResult.FAILED_TO_NEGOTIATE, connectionToUnencryptedPort.connect());

            RestartFramework.at("after_unencrypted_port_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void negotiatedProtocolMustBeAcceptedProtocolTest() throws Throwable
    {
        ...
        }).start())
        {
            ...
            RestartFramework.at("after_tls10_connection_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tls11_connection_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tls12_connection_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tls13_connection_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void connectionCannotAgreeOnClientAndServerTest() throws Throwable
    {
        ...
        }).start())
        {
            ...
            RestartFramework.at("after_cipher_mismatch_test")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    private void testEndpointVerification(boolean requireEndpointVerification, boolean ipInSAN) throws Throwable
    {
        ...
        {
            RestartFramework.at("after_cluster_start_endpoint_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_ssl_context_creation")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_driver_connection")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
