...
public class ReadRepairTest_RestartInjected extends TestBaseImpl
{
    /**
    ...
    public void readRepairTimeoutTest() throws Throwable
    {
        ...
        try (Cluster cluster = init(builder().withNodes(3).start()))
        {
            ...
            RestartFramework.at("timeout_after_table_create")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("timeout_after_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("timeout_after_filter_setup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void failingReadRepairTest() throws Throwable
    {
        try (Cluster cluster = init(builder().withNodes(3).start()))
        {
            ...
            RestartFramework.at("failing_after_table_create")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("failing_after_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("failing_after_filter_setup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void movingTokenReadRepairTest() throws Throwable
    {
        ...
        try (Cluster cluster = init(Cluster.build(4).withoutVNodes().withConfig(c -> c.set("reject_out_of_token_range_requests", false)).start(), 3))
        {
            ...
            RestartFramework.at("moving_after_table_create")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("moving_after_insert")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("moving_after_node_leaving")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
