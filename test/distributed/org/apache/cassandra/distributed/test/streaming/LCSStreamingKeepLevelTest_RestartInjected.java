...
public class LCSStreamingKeepLevelTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testDecom() throws IOException
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_populate_decom")
                .on(cluster)
                .restart("node")
                .withIndex(0)
    ...
    public void testMove() throws IOException
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_populate_move")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
