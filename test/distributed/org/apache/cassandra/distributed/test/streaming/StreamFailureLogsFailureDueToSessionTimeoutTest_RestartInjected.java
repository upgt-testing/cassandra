...
public class StreamFailureLogsFailureDueToSessionTimeoutTest_RestartInjected extends AbstractStreamFailureLogs
{
    @Test
    public void failureDueToSessionTimeout() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            try
            {
                ...
                RestartFramework.at("after_first_await")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_unblock_signal")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
