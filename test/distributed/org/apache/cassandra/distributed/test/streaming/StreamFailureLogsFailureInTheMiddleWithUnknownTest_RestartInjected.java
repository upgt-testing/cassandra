...
public class StreamFailureLogsFailureInTheMiddleWithUnknownTest_RestartInjected extends AbstractStreamFailureLogs
{
    @Test
    public void failureInTheMiddleWithUnknown() throws IOException
    {
        boolean zeroCopyStreaming = true;
        String reason = "java.lang.RuntimeException: TEST";
        Integer failedNode = FAILING_NODE;
