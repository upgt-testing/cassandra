...
public class StreamCloseInMiddleTest_RestartInjected extends TestBaseImpl
{
    @Test
    ...
    private void streamClose(boolean zeroCopyStreaming) throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_schema_create")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_first_shutdown_check")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_bootstrap_log_verification")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
