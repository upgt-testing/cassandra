...
public class OverloadTest_RestartInjected extends TestBaseImpl
{
    @Test
                                           ...
                                           .start()))
        {
            ...
            for (ProtocolVersion protocolVersion : new ProtocolVersion[]{ ProtocolVersion.V4, ProtocolVersion.V5 })
            {
                     ...
                     Session session = cluster.connect(KEYSPACE))
                {
                    ...
                    RestartFramework.at("after_enable_slow_select")
                        .on(control)
                        .restart("node")
                        .withIndex(0)
                        .withMode(RestartMode.GRACEFUL)
                    ...
                    RestartFramework.at("after_backpressure_validation")
                        .on(control)
                        .restart("node")
                        .withIndex(0)
                        .withMode(RestartMode.GRACEFUL)
    ...
    public void testFinishInProgressQueries() throws Throwable
    {
             ...
             Session session = cluster.connect(KEYSPACE))
        {
            ...
            RestartFramework.at("after_future_processing")
                .on(control)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
