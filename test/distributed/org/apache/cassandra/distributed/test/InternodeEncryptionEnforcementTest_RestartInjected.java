...
public final class InternodeEncryptionEnforcementTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testInboundConnectionsAreRejectedWhenAuthFails() throws IOException, TimeoutException
    {
        ...
        try (Cluster cluster = builder.start(); Closeable es = executorService::shutdown)
        {
            ...
            RestartFramework.at("after_open_connections")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_auth_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testOutboundConnectionsAreInterruptedWhenAuthFails() throws IOException, TimeoutException
    {
        ...
        try (Cluster cluster = builder.start(); Closeable es = executorService::shutdown)
        {
            ...
            RestartFramework.at("after_logs_watch")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testConnectionsAreRejectedWithInvalidConfig() throws Throwable
    {
        ...
        try (Cluster cluster = builder.start())
        {
            ...
            RestartFramework.at("after_connection_attempt")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_instance1_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_instance2_verification")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
