...
public class TableEstimatesTest_RestartInjected extends TestBaseImpl
{
    ...
    public void refreshTableEstimatesClearsInvalidEntries()
    {
        ...
        RestartFramework.at("after_invalid_table_estimates_inserts")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
        ...
        RestartFramework.at("after_refresh_table_estimates")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_table_estimates_verification")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void refreshSizeEstimatesClearsInvalidEntries()
    {
        ...
        RestartFramework.at("after_invalid_size_estimates_inserts")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_refresh_size_estimates")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_size_estimates_verification")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
