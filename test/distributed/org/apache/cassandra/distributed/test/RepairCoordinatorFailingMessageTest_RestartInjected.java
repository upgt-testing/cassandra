...
public class RepairCoordinatorFailingMessageTest_RestartInjected extends TestBaseImpl implements Serializable
{
    ...
    public void prepareIrFailure()
    {
        ...
        RestartFramework.at("pir_after_table_create")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
        ...
        RestartFramework.at("pir_after_filter_setup")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        try
        {
            ...
            RestartFramework.at("pir_after_repair")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void validationFailure()
    {
        ...
        RestartFramework.at("vf_after_table_create")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("vf_after_filter_setup")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        try
        {
            ...
            result.asserts()
                  ...
                  .notificationContains(NodeToolResult.ProgressEventType.COMPLETE, "finished with error");
            RestartFramework.at("vf_after_repair")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void streamFailure()
    {
        ...
        CLUSTER.schemaChange(format("CREATE TABLE %s.%s (key text, value text, PRIMARY KEY (key))", KEYSPACE, table));
        RestartFramework.at("sf_after_table_create")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("sf_after_insert")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("sf_after_filter_setup")
            .on(CLUSTER)
            .restart("node")
            .withIndex(2)
            .withMode(RestartMode.GRACEFUL)
        ...
        try
        {
            ...
            result.asserts()
                  ...
                  .notificationContains(NodeToolResult.ProgressEventType.ERROR, "Some repair failed")
                  .notificationContains(NodeToolResult.ProgressEventType.COMPLETE, "finished with error");
            RestartFramework.at("sf_after_repair")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
