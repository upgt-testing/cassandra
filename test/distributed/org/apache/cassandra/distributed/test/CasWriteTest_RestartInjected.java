...
public class CasWriteTest_RestartInjected extends TestBaseImpl
{
    ...
    {
        RestartFramework.at("before_contention_test")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testStaleCommitInSystemPaxos() throws InterruptedException
    {
        ...
        RestartFramework.at("after_paxos_purge_config")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_cas_delete")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
