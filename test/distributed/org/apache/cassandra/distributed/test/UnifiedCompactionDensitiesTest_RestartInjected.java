...
public class UnifiedCompactionDensitiesTest_RestartInjected extends TestBaseImpl
{
    @Test
    ...
    private void testTargetSSTableSize(int nodeCount, int dataDirs) throws IOException
    {
                                             ...
                                             .start()))
        {
            ...
            RestartFramework.at("after_keyspace_alter")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_first_write_flush_cycle")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_size_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_write_flush_cycle")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_size_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_final_size_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
