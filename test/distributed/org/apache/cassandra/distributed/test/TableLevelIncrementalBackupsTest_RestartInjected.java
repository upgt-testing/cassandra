...
public class TableLevelIncrementalBackupsTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testIncrementalBackupEnabledCreateTable() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_table_create_with_backups_enabled")
                .on(c)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_first_flush_with_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_second_flush_with_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_drop_table_with_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_table2_create_with_backups_disabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_flush_without_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testIncrementalBackupEnabledAlterTable() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_alter_create_with_backups_disabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_flush_with_backups_disabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_enable_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_flush_with_backups_enabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_table2_create_with_backups_enabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_table2_flush_with_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_disable_backups")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_alter_final_flush")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testIncrementalBackupWhenCreateTableByDefault() throws Exception
    {
        try (Cluster c = getCluster(true))
        {
            ...
            RestartFramework.at("after_default_table_create")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_first_flush")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_alter_disable")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_flush_disabled")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_alter_reenable")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_default_final_flush")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
