...
public class DataResurrectionCheckTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testDataResurrectionCheck() throws Exception
    {
        ...
        try (WithProperties properties = new WithProperties().set(CHECK_DATA_RESURRECTION_HEARTBEAT_PERIOD, 3600000))
        {
                                          ...
                                          .start())
            {
                ...
                RestartFramework.at("after_violation_detection")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_exclusion_tests")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
