 ...
 */
public class AssassinatedEmptyNodeTest_RestartInjected extends BaseAssassinatedCase
{
    @Test
    @Override
    public void test() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_node_stop_restart")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_assassinate")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_gossip_status_left")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_status_left_hook")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_replace_attempt_failed")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
