...
public class HostReplacementTest_RestartInjected extends TestBaseImpl
{
    ...
    public void replaceDownedHost() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_replace_start")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_ring_join")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void replaceAliveHost() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("before_replace_attempt")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_replace_failure")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void seedGoesDownBeforeDownHost() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            RestartFramework.at("after_collect_state_tokens")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_seed_stop")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_assert_in_ring")
                .on(cluster)
                .restart("node")
                .withIndex(2)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_token_verification")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
