...
public class FailedBootstrapTest_RestartInjected extends TestBaseImpl
{
    ...
    public void roleSetupDoesNotProduceUnavailables() throws IOException
    {
        ...
        try (Cluster cluster = builder.start())
        {
            ...
            RestartFramework.at("after_gossip_info")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_await_setup_counter")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
