 ...
 */
public class StrictFilteringTest_RestartInjected extends TestBaseImpl
{
    ...
    public void shouldDegradeToUnionOnSingleStatic()
    {
        ...
        RestartFramework.at("after_index_create")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testPartialUpdatesOnNonIndexedColumnsAfterRepair()
    {
        ...
        RestartFramework.at("after_split_insert")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testNecessaryShortRead()
    {
        ...
        RestartFramework.at("after_third_insert")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
