...
public class PartialUpdateHandlingTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testPartialUpdateResolution()
    {
        ...
        if (specification.existing)
        {
            ...
            RestartFramework.at("after_repaired_rows")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
        ...
        RestartFramework.at("after_partial_updates")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
