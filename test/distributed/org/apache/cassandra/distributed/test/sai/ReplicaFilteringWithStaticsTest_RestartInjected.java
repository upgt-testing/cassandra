...
public class ReplicaFilteringWithStaticsTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testRowFilterDeletePurging(boolean sai)
    {
        ...
        if (sai)
        {
            ...
            RestartFramework.at("after_sai_index_creation")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_initial_update")
            .on(CLUSTER)
            .restart("node")
            .withIndex(2)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testStaticMatchWithPartitionDelete(boolean sai)
    {
        ...
        RestartFramework.at("after_table_create_static")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        if (sai)
        {
            ...
            RestartFramework.at("after_sai_index_creation_static")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_partition_delete")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_multiple_inserts")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_static_update")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testMissingStaticRowWithNonStaticExpression(boolean sai)
    {
        ...
        RestartFramework.at("after_table_create_expression")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        if (sai)
        {
            ...
            RestartFramework.at("after_sai_index_creation_expression")
                .on(CLUSTER)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_initial_insert")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_static_column_update")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
