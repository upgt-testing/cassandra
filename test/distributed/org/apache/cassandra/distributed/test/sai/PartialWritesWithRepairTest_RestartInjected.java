...
public class PartialWritesWithRepairTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void test() throws IOException
    {
                ...
                .start())
        {
            ...
            RestartFramework.at("after_complete_range_writes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_partial_range_writes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
