...
public class NativeProtocolTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void withClientRequests() throws Throwable
    {
        try (ICluster cassandraCluster = init(builder().withNodes(3)
    ...
    public void withCounters() throws Throwable
    {
                                              ...
                                              .start()))
        {
            ...
            RestartFramework.at("after_counter_table_create")
                .on((Cluster) cassandraCluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_counter_update")
                .on((Cluster) cassandraCluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void restartTransportOnGossippingOnlyMember() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_gossipping_member_startup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_stop_native_transport")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_start_native_transport")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testBinaryReflectsRpcReadiness() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            RestartFramework.at("after_cluster_start_transport_disabled")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_enable_native_transport")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_disable_native_transport")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
