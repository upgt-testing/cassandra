...
public class FqlReplayDDLExclusionTest_RestartInjected extends TestBaseImpl
{
    @Rule
    ...
    public void test() throws Throwable
    {
                                                   ...
                                                   .start()))
        {
                 ...
                 Session s = c.connect())
            {
                ...
                RestartFramework.at("after_negative_replay")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_positive_replay")
                    .on(cluster)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
