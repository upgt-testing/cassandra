 ...
 */
public class GuardrailItemsPerCollectionOnSSTableWriteTest_RestartInjected extends GuardrailTester
{
    ...
    public void testSetSize() throws Throwable
    {
        ...
        RestartFramework.at("after_warning_inserts")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetSizeWithUpdates()
    {
        ...
        RestartFramework.at("after_initial_updates")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_warning_updates")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetSizeAfterCompaction() throws Throwable
    {
        ...
        RestartFramework.at("after_warning_compaction")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testListSizeAfterCompaction() throws Throwable
    {
        ...
        RestartFramework.at("after_failed_compaction")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testCompositePartitionKey()
    {
        ...
        RestartFramework.at("after_first_insert")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
