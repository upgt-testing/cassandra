 ...
 */
public class GuardrailPartitionTombstonesTest_RestartInjected extends GuardrailTester
{
    ...
    private void testPartitionTombstones(int warn, int fail)
    {
        ...
        RestartFramework.at("after_populate_below_threshold")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_populate_warn_threshold")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_populate_fail_threshold")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_delete_reduce_tombstones")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_multi_partition_tombstones")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
