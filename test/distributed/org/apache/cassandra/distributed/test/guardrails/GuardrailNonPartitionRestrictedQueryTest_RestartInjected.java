...
public class GuardrailNonPartitionRestrictedQueryTest_RestartInjected extends GuardrailTester
{
    ...
    public void testGuardrailForLegacy2i()
    {
        ...
        RestartFramework.at("after_schema_prepare")
            .on(cluster)
            .restart("node")
            .withIndex(0)
    ...
    public void testSAIWarnThreshold()
    {
        ...
        RestartFramework.at("after_first_sstable_creation")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_warn_threshold_trigger")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_threshold_change")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSAIFailThreshold()
    {
        ...
        RestartFramework.at("after_fail_threshold_trigger")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
