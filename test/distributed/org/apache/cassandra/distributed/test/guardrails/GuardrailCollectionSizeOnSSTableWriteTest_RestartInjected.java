 ...
 */
public class GuardrailCollectionSizeOnSSTableWriteTest_RestartInjected extends GuardrailTester
{
    ...
    public void testSetSize() throws Throwable
    {
        ...
        RestartFramework.at("after_insert_no_warn")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_warn_flush")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_fail_flush")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetSizeFrozen()
    {
        ...
        RestartFramework.at("after_frozen_table_create")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_frozen_flush")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetSizeWithUpdates()
    {
        ...
        RestartFramework.at("after_update_table_create")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_update_no_warn")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_update_warn")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSetSizeAfterCompaction() throws Throwable
    {
        ...
        RestartFramework.at("after_compaction_table_create")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_no_warn_compact")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_warn_compact")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_fail_compact")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testCompositePartitionKey()
    {
        ...
        RestartFramework.at("after_composite_partition_table_create")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_composite_partition_warn")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testCompositeClusteringKey()
    {
        ...
        RestartFramework.at("after_composite_clustering_table_create")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_composite_clustering_warn")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
