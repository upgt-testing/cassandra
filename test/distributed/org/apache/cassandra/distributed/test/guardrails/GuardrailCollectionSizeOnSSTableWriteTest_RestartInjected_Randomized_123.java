 ...
 */
public class GuardrailCollectionSizeOnSSTableWriteTest_RestartInjected_Randomized_123 extends GuardrailTester {
    ...
    public static void setupCluster() throws IOException {
        cluster = init(Cluster.build(NUM_NODES).withConfig(c -> c.with(Feature.GOSSIP, Feature.NATIVE_PROTOCOL).set("collection_size_warn_threshold", WARN_THRESHOLD + "B").set("collection_size_fail_threshold", FAIL_THRESHOLD + "B")).start());
    ...
    public void testSetSize() throws Throwable {
        ...
        RestartFramework.at("after_insert_no_warn").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_fail_flush").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_warn_flush").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetSizeFrozen() {
        ...
        execute("INSERT INTO %s (k, v) VALUES (0, null)");
        RestartFramework.at("after_frozen_flush").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        execute("INSERT INTO %s (k, v) VALUES (1, ?)", set());
        RestartFramework.at("after_frozen_table_create").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        execute("INSERT INTO %s (k, v) VALUES (2, ?)", set(allocate(1)));
        execute("INSERT INTO %s (k, v) VALUES (4, ?)", set(allocate(WARN_THRESHOLD)));
    ...
    public void testSetSizeWithUpdates() {
        ...
        RestartFramework.at("after_update_no_warn").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        assertNotWarnedOnFlush();
        ...
        RestartFramework.at("after_update_warn").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_update_table_create").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetSizeAfterCompaction() throws Throwable {
        schemaChange("CREATE TABLE %s (k int PRIMARY KEY, v set<blob>)");
        RestartFramework.at("after_no_warn_compact").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        execute("INSERT INTO %s (k, v) VALUES (0, ?)", set(allocate(1)));
        RestartFramework.at("after_fail_compact").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        assertNotWarnedOnFlush();
        execute("UPDATE %s SET v = v + ? WHERE k = 0", set(allocate(1)));
        assertNotWarnedOnFlush();
        ...
        RestartFramework.at("after_warn_compact").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_compaction_table_create").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCompositePartitionKey() {
        ...
        RestartFramework.at("after_composite_partition_table_create").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        execute("INSERT INTO %s (k1, k2, v) VALUES (0, 'a', ?)", set(allocate(WARN_THRESHOLD)));
        assertWarnedOnFlush(warnMessage("(0, 'a')"));
        RestartFramework.at("after_composite_partition_warn").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCompositeClusteringKey() {
        ...
        RestartFramework.at("after_composite_clustering_warn").on(cluster).restart("node").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_composite_clustering_table_create").on(cluster).restart("node").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
