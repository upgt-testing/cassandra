 ...
 */
public class IndexDroppingTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testIndexDropping() throws Throwable
    {
        ...
        RestartFramework.at("after_index_built")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("before_restart")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_restart")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
