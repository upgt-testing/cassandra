...
public class ReprepareNewBehaviourTest_RestartInjected extends ReprepareTestBase
{
    @Test
    public void testUseWithMultipleKeyspaces() throws Throwable
    {
                                                            ...
                                                            .start()))
        {
                 ...
                 Session session = cluster.connect())
            {
                ...
                RestartFramework.at("after_prepare_ks1")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_insert_ks2")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_query_ks1")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_switch_ks2")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_prepare_ks2")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
                ...
                RestartFramework.at("after_query_ks2")
                    .on(c)
                    .restart("node")
                    .withIndex(0)
                    .withMode(RestartMode.GRACEFUL)
