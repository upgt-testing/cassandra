...
public class QueriesTableTest_RestartInjected extends TestBaseImpl
{
    ...
    public void shouldExposeReadsAndWrites() throws Throwable
    {
        ...
        RestartFramework.at("after_sync_queries")
            .on(SHARED_CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void shouldExposeCAS() throws Throwable
    {
        ...
        RestartFramework.at("cas_after_table_create")
            .on(SHARED_CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("cas_after_async_update")
            .on(SHARED_CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("cas_after_async_select")
            .on(SHARED_CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
