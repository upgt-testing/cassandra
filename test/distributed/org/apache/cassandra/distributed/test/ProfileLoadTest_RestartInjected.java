...
public class ProfileLoadTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testScheduledSamplingTaskLogs() throws IOException
    {
        try (Cluster cluster = init(Cluster.build(1).start()))
        {
            ...
            RestartFramework.at("after_profileload_start")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_insert_loop")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_profileload_stop")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_assert_list_empty")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_specific_table_schedule")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testPreventDuplicatedSchedule() throws IOException
    {
        try (Cluster cluster = init(Cluster.build(1).start()))
        {
            ...
            RestartFramework.at("duplicate_after_table_create")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("duplicate_after_first_schedule")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("duplicate_after_duplicate_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("duplicate_after_sampling_all_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("duplicate_after_profileload_stop")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
