...
public class PreviewRepairSnapshotTest_RestartInjected extends TestBaseImpl
{
    /**
    ...
    public void testSnapshotOfSStablesContainingMismatchingTokens() throws IOException
    {
                                                                      ...
                                                                      .with(NETWORK)).start()))
        {
            ...
            RestartFramework.at("after_mark_repaired_initial")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_first_preview_repair")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mismatch_insert")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_mark_repaired_node2")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
