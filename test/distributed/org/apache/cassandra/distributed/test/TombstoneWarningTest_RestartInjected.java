...
public class TombstoneWarningTest_RestartInjected extends TestBaseImpl
{
    ...
    public void regularTombstonesLogTest()
    {
        ...
        RestartFramework.at("after_regular_tombstone_updates")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
    ...
    public void rowTombstonesLogTest()
    {
        ...
        RestartFramework.at("after_row_tombstone_deletes")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void rangeTombstonesLogTest()
    {
        ...
        RestartFramework.at("after_range_tombstone_deletes")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void ttlTest() throws InterruptedException
    {
        ...
        RestartFramework.at("after_ttl_inserts")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_ttl_updates")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_ttl_expiration")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void noTombstonesLogTest()
    {
        ...
        RestartFramework.at("after_no_tombstone_inserts")
            .on((Cluster) cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
