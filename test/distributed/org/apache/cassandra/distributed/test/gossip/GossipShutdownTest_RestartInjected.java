...
public class GossipShutdownTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void emptyStateAndShutdownEvent() throws IOException
    {
                               ...
                               .start())
        {
            ...
            RestartFramework.at("after_gossip_disable")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void emptyStateAndHostJoin() throws IOException, InterruptedException
    {
                               ...
                               .start())
        {
            ...
            RestartFramework.at("after_ring_join_host")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_filter_setup_host")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_startup_host")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_gossip_disable_host")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node_add")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_node3_startup")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
