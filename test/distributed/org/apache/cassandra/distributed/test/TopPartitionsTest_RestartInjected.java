...
public class TopPartitionsTest_RestartInjected extends TestBaseImpl
{
    public enum Repair
    {
    ...
    public void basicPartitionSizeTest() throws TimeoutException
    {
        ...
        RestartFramework.at("after_incremental_repair")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void configChangeTest() throws TimeoutException
    {
        ...
        RestartFramework.at("after_data_with_tombstones")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_10_elements")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_config_change_20")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_20_elements")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_config_change_5")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_5_elements")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void basicRowTombstonesTest() throws InterruptedException, TimeoutException
    {
        ...
        RestartFramework.at("after_row_deletions")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_non_purgeable")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_gc_grace_wait")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_purgeable")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_force_compact")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_repair_purged")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void basicRegularTombstonesTest() throws InterruptedException, TimeoutException
    {
        ...
        RestartFramework.at("after_regular_tombstones")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void basicRangeTombstonesTest() throws Throwable
    {
        ...
        RestartFramework.at("after_range_tombstones")
            .on(CLUSTER)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
