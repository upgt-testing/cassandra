...
public class RepairBoundaryTest_RestartInjected extends TestBaseImpl
{
    ...
    public void primaryRangeRepair()
    {
        populate();
        verify();
        RestartFramework.at("pr_after_populate")
            .on(cluster)
            .restart("node")
            .withIndex(0)
        ...
        RestartFramework.at("pr_after_deletes")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("pr_after_repair")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void singleTokenRangeRepair()
    {
        populate();
        verify();
        RestartFramework.at("str_after_populate")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("str_after_deletes")
            .on(cluster)
            .restart("node")
            .withIndex(2)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("str_after_repair")
            .on(cluster)
            .restart("node")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
