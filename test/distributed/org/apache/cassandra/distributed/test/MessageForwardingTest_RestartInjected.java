...
public class MessageForwardingTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void mutationsForwardedToAllReplicasTest()
    {
             ...
             )
        {
            ...
            RestartFramework.at("after_inserts_complete")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_tracing_sync")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_trace_retrieval")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_trace_processing")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
