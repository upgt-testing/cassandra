...
public class MetricsCountQueriesTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testMetricsCountQueries() throws Throwable
    {
        try (Cluster cluster = init(Cluster.create(2)))
        {
            ...
            RestartFramework.at("after_initial_read_count")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_select_queries")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
