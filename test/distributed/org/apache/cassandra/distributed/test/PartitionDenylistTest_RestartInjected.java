...
public class PartitionDenylistTest_RestartInjected extends TestBaseImpl
{
    ...
    public void checkStartupWithoutTriggeringUnavailable() throws IOException, InterruptedException, ExecutionException, TimeoutException
    {
                                      ...
                                      .createWithoutStarting())
        {
            ...
            RestartFramework.at("after_all_nodes_started")
                .on(cluster)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_unavailables_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void checkTimerRetriesLoad() throws IOException
    {
                                      ...
                                      .createWithoutStarting())
        {
            ...
            RestartFramework.at("after_timer_check")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
