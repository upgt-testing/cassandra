...
public class ByteBuddyExamplesTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void writeFailureTest() throws Throwable
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_write_attempt")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void countTest() throws IOException
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_select_node1")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_select_node2")
                .on(cluster)
                .restart("node")
                .withIndex(1)
                .withMode(RestartMode.GRACEFUL)
