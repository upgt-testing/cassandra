...
public class SSTableLoaderEncryptionOptionsTest_RestartInjected extends AbstractEncryptionOptionsImpl
{
    ...
    public void bulkLoaderSuccessfullyStreamsOverSsl() throws Throwable
    {
        ...
        RestartFramework.at("after_sstable_preparation")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
    ...
    public void bulkLoaderSuccessfullyStreamsOverSslWithDeprecatedSslStoragePort() throws Throwable
    {
        ...
        ToolRunner.ToolResult tool = ToolRunner.invokeClass(BulkLoader.class,
                                                            ...
                                                            "--conf-path", "test/conf/sstableloader_with_encryption.yaml",
                                                            sstables_to_upload.absolutePath());
        RestartFramework.at("after_bulk_load_deprecated_port")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    {
        RestartFramework.at("before_tls_protocol_mismatch")
            .on(CLUSTER)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
