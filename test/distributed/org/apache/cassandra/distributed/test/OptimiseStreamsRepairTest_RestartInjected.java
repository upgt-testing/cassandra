...
public class OptimiseStreamsRepairTest_RestartInjected extends TestBaseImpl
{
    @Test
    public void testBasic() throws Exception
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_initial_data_insert")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_divergent_writes")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_flush_all")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            res.asserts().success();
            RestartFramework.at("after_optimised_repair")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            RestartFramework.at("after_validation_repair")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void randomTest() throws IOException, TimeoutException
    {
                                          ...
                                          .start()))
        {
            ...
            RestartFramework.at("after_random_inserts")
                .on(cluster)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
