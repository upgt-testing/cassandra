...
public class EphemeralSnapshotTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testStartupRemovesEphemeralSnapshotOnEphemeralFlagInManifest() throws Exception
    {
                                       ...
                                       .start()))
        {
            ...
            RestartFramework.at("after_initialization")
                .on(c)
                .restart("node")
                .withIndex(0)
            ...
            RestartFramework.at("after_manifest_rewrite")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testStartupRemovesEphemeralSnapshotOnMarkerFile() throws Exception
    {
                                       ...
                                       .start()))
        {
            ...
            RestartFramework.at("after_marker_file_create")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testEphemeralSnapshotIsNotClearableFromNodetool() throws Exception
    {
                                       ...
                                       .start()))
        {
            ...
            RestartFramework.at("after_listsnapshots")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
            ...
            assertTrue(instance.nodetoolResult("listsnapshots", "-e").getStdout().contains(snapshotName));
            RestartFramework.at("after_clearsnapshot_attempt")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void testClearingAllSnapshotsFromNodetoolWillKeepEphemeralSnaphotsIntact() throws Exception
    {
                                       ...
                                       .start()))
        {
            ...
            RestartFramework.at("after_clearsnapshot_all")
                .on(c)
                .restart("node")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
