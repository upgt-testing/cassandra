...
public class NodeToolEnableDisableBinaryTest_RestartInjected extends TestBaseImpl
{
    ...
    public void testMaybeChangeDocs()
    {
        ...
        RestartFramework.at("after_disablebinary_help")
            .on(cluster)
            .restart("node")
            .withIndex(0)
        ...
        help =  "NAME\n" +
                ...
                "\n";
        Assertions.assertThat(tool.getStdout()).isEqualTo(help);
        RestartFramework.at("after_enablebinary_help")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testEnableDisableBinary() throws Throwable
    {
        ...
        RestartFramework.at("after_initial_connection_check")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_disable_verification")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_enable_binary")
            ...
            .execute();
        assertTrue(canConnect());
        RestartFramework.at("after_enable_verification")
            .on(cluster)
            .restart("node")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
